    ...
    <body>
      ...
      <section class="todoapp">
        ...
        <header class="header">
          ...
          <h1>todos</h1>
          <input class="new-todo" placeholder="What needs to be done?" autofocus v-model="tache" @keyup.enter="ajouter()">
        ...
        <footer class="footer">
          ...
          <span class="todo-count"><strong>{{this.listetache.length}}</strong> item left</span>
